...
{
    public class RepositoryBaseManaged
    {
        private ConnectionClientDetail clientDetail;

        public RepositoryBaseManaged()
        {

        }

        public RepositoryBaseManaged(string ConnectionName, ConnectionClientDetail ClientDetail = null)
        {
            try
            {
        ...
        public RepositoryBaseManaged(string ConnectionName, bool Pooling, ConnectionClientDetail ClientDetail = null)
        {
            try
            {
        ...
        public RepositoryBaseManaged(OracleConnection _connection)
        {
            try
            {
